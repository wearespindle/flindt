            ...
            <div className="feedback-form--row padding-bottom-0">
              <div className="feedback-form--form">
                <form onSubmit={handleSubmit(this._handleSubmit)}>
                  ...
                  <div className="feedback-form--row">
                    <div>
                      <strong>How recognizable is the feedback you received from {person.first_name}?</strong>
                      ...
                      {isEditable && (
                        <div>
                          <ul className="feedback--form-radiolist">
                            <li>
                              <Field name="actionable" component={renderInput} type="radio" id="yes" value="true" />
                              <label htmlFor="yes">Yes, because</label>
                            </li>
                            <li>
                              <Field name="actionable" component={renderInput} type="radio" id="no" value="false" />
