...
class GiveFeedbackListArchive extends Component {
    ...
    componentWillMount() {
        ...
        this.props.fetchFeedbackAsSender(accessToken, this.state.limit, offset).then((response) => {
            this.setState({pageCount: Math.ceil(response.payload.data.count / this.state.limit)});
        });
    }
